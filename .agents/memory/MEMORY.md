...
- [Hospital ID in Scheduler](hospital-id-scheduler-pattern.md) — patients/care_plans/queue need h.hospital_code (UUID); h.id (integer) silently returns nothing for those tables
