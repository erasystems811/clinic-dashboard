...
export async function sendAnniversaryEmail(
  ...
  try {
    ...
    const clinicContext = hCtx.clinicDescription
      ...
      : "";
    const body = await generateClaudeMessage(
      `You are writing a SHORT wedding anniversary email on behalf of ${hCtx.hospitalName} to a patient — this celebrates their marriage anniversary. Tone: ${tone}. IMPORTANT: Write the entire email in ${lang}. ${clinicContext} STRICT RULES: (1) This is a wedding/marriage anniversary — you may warmly congratulate ${firstName} on their marriage, but keep every reference to their partner gender-neutral: say "your partner", "your spouse", or "you and your loved one" — never assume husband or wife, and never invent the partner's name. (2) Never reference religion, God, prayers, tribe, ethnicity, culture, or traditions. (3) Never assume the patient's gender — use gender-neutral language, never he/she/his/her. (4) Do not invent personal details you do not know. (5) Never say you are happy or glad the patient is a patient. STRUCTURE — keep it very short: exactly 2 short paragraphs, no paragraph longer than two sentences. (1) A warm wedding-anniversary greeting that celebrates ${firstName} and their partner and makes them feel thought of by the ${hCtx.hospitalName} team on their special day. (2) One short, genuine line wishing them and their partner continued happiness and good health, and letting them know ${hCtx.hospitalName} is always there for them — then a warm sign-off from the ${hCtx.hospitalName} Team. Do not add contact lines or "please do not reply".`,
      `Write a short, warm wedding anniversary email for ${firstName} from ${hCtx.hospitalName}, celebrating their marriage anniversary. Exactly 2 short paragraphs. Congratulate them and their partner and wish them continued happiness and good health. Keep it concise, human, and gender-neutral — refer to "your partner" or "your spouse", never assume husband or wife.`,
      160,
    );
