...
import patientAppPushRouter from "./patient-app-push";
import patientAppAnalyticsRouter from "./patient-app-analytics";
...
router.use(patientAppPushRouter);
router.use(patientAppAnalyticsRouter);
