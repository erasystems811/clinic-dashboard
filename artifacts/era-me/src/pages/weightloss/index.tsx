        ...
        <div className="flex items-center gap-2">
          ...
          {(profile?.cheatDaysAvailable ?? 0) > 0 && (
            <span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-bold"
              style={{ background: `${WL_COLOR}22`, color: WL_COLOR, border: `1px solid ${WL_COLOR}40` }}>
      ...
      <div className="flex justify-center mt-6 mb-6">
        <div className="relative">
          <svg width={140} height={140} viewBox="0 0 140 140">
            ...
            <text x={70} y={96} textAnchor="middle" fontSize="10" fontWeight="700" fill={WL_COLOR} fontFamily="inherit">
...
function Spinner() {
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="w-6 h-6 border-2 border-t-transparent rounded-full animate-spin" style={{ borderColor: `${WL_COLOR} transparent transparent transparent` }} />
    </div>
  );
}
