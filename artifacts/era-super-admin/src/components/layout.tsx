...
import {
  ...
  PanelLeftClose, PanelLeftOpen, Menu, X, FlaskConical, TrendingUp, Headphones, BookOpen, Bell, Brain,
} from "lucide-react";
...
const NAV = [
  ...
  { icon: Brain,         label: "Knowledge Base",     href: "/knowledge-base",   sub: "Feature docs + AI context" },
