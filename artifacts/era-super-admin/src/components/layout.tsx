...
import {
  ...
  PanelLeftClose, PanelLeftOpen, Menu, X, FlaskConical, TrendingUp, Headphones, BookOpen, Bell, Star, Kanban, Activity, Database, MonitorPlay,
} from "lucide-react";
...
const NAV = [
  ...
  { icon: MonitorPlay,   label: "Demo Sessions",      href: "/demo-sessions",      sub: "Prospect demo activity" },
