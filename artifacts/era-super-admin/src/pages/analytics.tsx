...
function StatCard({ label, value, icon: Icon, color, gold, loading, sub }: {
  ...
  return (
    <div className={`relative flex flex-col justify-between p-4 border transition-all duration-150 ${
      gold ? "border-[hsl(43_70%_62%/0.2)] bg-[hsl(43_70%_62%/0.04)]" : "border-[hsl(220_18%_38%)] bg-[hsl(220_20%_18%)]"
    }`}>
      {gold && <>
  ...
  return (
    <div title={[check.detail, check.balance].filter(Boolean).join(" · ")}
      className={`p-3.5 border flex flex-col gap-3 cursor-default select-none ${
        fail ? "border-red-500/20 bg-red-500/5" : warn ? "border-amber-500/15 bg-amber-500/4" : "border-[hsl(220_18%_38%)] bg-[hsl(220_20%_18%)]"
      }`}>
...
function LogRow({ log }: { log: AutomationLog }) {
  ...
  return (
    <div className="flex items-center gap-3 py-2.5 border-b border-[hsl(220_18%_26%)] last:border-0 group">
  ...
  return (
    <Layout>
      ...
      <div className="flex items-start justify-between mb-5">
        ...
        <div className="flex items-center gap-3 mt-1">
          ...
          <button onClick={fetchAll}
            className="p-1.5 border border-[hsl(220_18%_32%)] text-muted-foreground/40 hover:text-muted-foreground hover:border-[hsl(220_18%_38%)] transition">
      ...
      <div className="mb-5">
        ...
        {healthLoading ? (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
            {[1,2,3,4,5,6].map(i => <div key={i} className="h-20 border border-[hsl(220_18%_36%)] bg-[hsl(220_20%_18%)] animate-pulse" />)}
          </div>
        ) : health ? (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
          ...
          <div className="flex items-center gap-2 py-6 border border-[hsl(220_18%_36%)] px-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-5">
        ...
        <div className="border border-[hsl(220_18%_38%)] bg-[hsl(220_20%_18%)]">
          <div className="flex items-center justify-between px-4 py-3 border-b border-[hsl(220_18%_36%)]">
              ...
              {needsAttention.slice(0, 6).map(h => {
                ...
                return (
                  <button key={h.id} onClick={() => setLocation(`/hospitals/${h.id}`)}
                    className="w-full flex items-center gap-3 px-4 py-3 hover:bg-[hsl(220_20%_22%)] transition group text-left">
                    <div className="w-6 h-6 border border-[hsl(220_18%_34%)] bg-[hsl(220_20%_14%)] flex items-center justify-center shrink-0">
          ...
          {needsAttention.length > 6 && (
            <div className="border-t border-[hsl(220_18%_26%)] px-4 py-2">
        ...
        <div className="border border-[hsl(220_18%_38%)] bg-[hsl(220_20%_18%)]">
          ...
          {logs.length > 0 && (
            <div className="border-t border-[hsl(220_18%_26%)] px-4 py-2 flex items-center justify-between">
      ...
      {/* Footer */}
      <div className="mt-8 pt-5 border-t border-[hsl(220_16%_20%)]">
