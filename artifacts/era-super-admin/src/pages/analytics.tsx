...
function StatCard({ label, value, icon: Icon, color, gold, loading, sub }: {
  ...
  return (
    <div className={`relative flex flex-col justify-between p-4 border transition-all duration-150 ${
      gold ? "border-[hsl(43_65%_58%/0.2)] bg-[hsl(43_65%_58%/0.04)]" : "border-[hsl(220_12%_13%)] bg-[hsl(220_14%_7%)]"
    }`}>
      {gold && <>
        <span className="absolute top-0 left-0 w-4 h-px bg-[hsl(43_65%_58%/0.5)]" />
        <span className="absolute top-0 left-0 w-px h-4 bg-[hsl(43_65%_58%/0.5)]" />
      </>}
  ...
  return (
    <div title={[check.detail, check.balance].filter(Boolean).join(" · ")}
      className={`p-3.5 border flex flex-col gap-3 cursor-default select-none ${
        fail ? "border-red-500/20 bg-red-500/5" : warn ? "border-amber-500/15 bg-amber-500/4" : "border-[hsl(220_12%_13%)] bg-[hsl(220_14%_7%)]"
      }`}>
...
function LogRow({ log }: { log: AutomationLog }) {
  ...
  return (
    <div className="flex items-center gap-3 py-2.5 border-b border-[hsl(220_12%_11%)] last:border-0 group">
  ...
  return (
    <Layout>
      ...
      <div className="flex items-start justify-between mb-5">
        ...
        <div className="flex items-center gap-3 mt-1">
          ...
          <button onClick={fetchAll}
            className="p-1.5 border border-[hsl(220_12%_14%)] text-muted-foreground/40 hover:text-muted-foreground hover:border-[hsl(220_12%_20%)] transition">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-5">
        ...
        <div className="border border-[hsl(220_12%_13%)] bg-[hsl(220_14%_7%)]">
          <div className="flex items-center justify-between px-4 py-3 border-b border-[hsl(220_12%_12%)]">
              ...
              {needsAttention.slice(0, 6).map(h => {
                ...
                return (
                  <button key={h.id} onClick={() => setLocation(`/hospitals/${h.id}`)}
                    className="w-full flex items-center gap-3 px-4 py-3 hover:bg-[hsl(220_14%_9%)] transition group text-left">
                    <div className="w-6 h-6 border border-[hsl(220_12%_16%)] bg-[hsl(220_14%_6%)] flex items-center justify-center shrink-0">
                    ...
                    <div className="shrink-0 text-right">
                      ...
                      {!isTrial && daysLeft !== null && <span className="text-[9px] font-bold text-[hsl(43_65%_58%/0.7)] uppercase tracking-wider">{daysLeft}d left</span>}
                    </div>
          ...
          {needsAttention.length > 6 && (
            <div className="border-t border-[hsl(220_12%_11%)] px-4 py-2">
        ...
        <div className="border border-[hsl(220_12%_13%)] bg-[hsl(220_14%_7%)]">
          ...
          {logs.length > 0 && (
            <div className="border-t border-[hsl(220_12%_11%)] px-4 py-2 flex items-center justify-between">
      ...
      {/* Footer */}
      <div className="mt-8 pt-5 border-t border-[hsl(220_12%_10%)]">
