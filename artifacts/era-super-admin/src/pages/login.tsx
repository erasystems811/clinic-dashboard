...
export default function LoginPage() {
  ...
  const inputCls = "w-full pl-10 pr-10 py-2.5 bg-[hsl(220_14%_20%)] border border-[hsl(220_14%_26%)] text-foreground text-sm placeholder:text-muted-foreground/40 focus:outline-none focus:border-primary/60 focus:ring-1 focus:ring-primary/30 transition-all duration-150 font-medium tracking-wide";
      ...
      <div className="w-full max-w-xs relative z-10">
        ...
        {screen === "login" && (
          <form onSubmit={submit} className="space-y-4">
            <div className="border border-[hsl(220_14%_24%)] bg-card space-y-3 p-4"
              style={{ boxShadow: "0 16px 40px rgba(0,0,0,0.6), 0 0 0 1px hsl(220 18% 28% / 0.6)" }}>

              <div className="border-b border-[hsl(220_14%_24%)] pb-3 mb-1">
        ...
        {screen === "recover" && (
          <div className="space-y-4">
            {recoveryDone ? (
              <div className="border border-[hsl(220_14%_24%)] bg-card p-6 flex flex-col items-center gap-4 text-center">
              ...
              <form onSubmit={recover} className="space-y-4">
                <div className="border border-[hsl(220_14%_24%)] bg-card space-y-3 p-4"
                  ...
                  <div className="border-b border-[hsl(220_14%_24%)] pb-3">
