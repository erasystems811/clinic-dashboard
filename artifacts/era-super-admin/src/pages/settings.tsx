...
const SCHEDULE = [
  ...
  { time: "Daily 8 AM",   jobs: ["Birthday emails (second run)"] },
...
const AUTOMATIONS: AutomationDef[] = [
  ...
  { id: "birthday_email", name: "Birthday Greeting", purpose: "Deepens the patient relationship with a personal touch that most clinics never bother with.", trigger: "Patient's date of birth matches today's date", channel: "email", icon: Gift, timing: "Daily at 7 AM and 8 AM" },
